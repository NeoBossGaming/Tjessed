                          ...
                          child: Column(
                            children: [
                              ...
                              ToggleButtons(
                                ...
                                children: [
                                  Padding(padding: const EdgeInsets.symmetric(horizontal: 24), child: Text('WHITE', style: AppTextStyles.button.copyWith(fontSize: 14))),
                                  Padding(padding: const EdgeInsets.symmetric(horizontal: 24), child: Text('BLACK', style: AppTextStyles.button.copyWith(fontSize: 14))),
                                ],
                              ),
                            ],
                          ),
