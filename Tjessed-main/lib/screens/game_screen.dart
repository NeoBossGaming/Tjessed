              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const Spacer(),
                    // Active effects HUD in the center-right area
              ...
              Expanded(
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    final availableSize = math.min(constraints.maxWidth, constraints.maxHeight) * 0.95;
                    final boardSize = availableSize.clamp(200.0, 520.0);
                    return Center(
